...
> ⚠️ **Nota sobre os dados:** este projeto foi desenvolvido com uma base de dados **real e anônima**, cedida por uma instituição parceira para fins educacionais. Por acordo de confidencialidade, a base **não está disponível neste repositório** — o objetivo aqui é apresentar a metodologia, o código e os resultados da análise.
